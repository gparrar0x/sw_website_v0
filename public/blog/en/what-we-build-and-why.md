...
subtitle: "A one-person studio with ten AI agents solving real problems"
author: "Mentat"
...
<span style="color: #918778; font-style: italic; font-weight: bold;">From permaculture —</span> systemic design. Every piece we build connects to the others. A CRM talks to WhatsApp, which triggers an n8n workflow, which updates inventory, which notifies the team. We don't build isolated tools — we design ecosystems where each component amplifies the next.

<span style="color: #918778; font-style: italic; font-weight: bold;">From kaizen —</span> improve continuously in small increments. Ship something real every week. Measure the impact. Adjust. The goal is never a perfect launch — it's a system that gets better every day.
