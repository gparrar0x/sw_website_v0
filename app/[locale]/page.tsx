...
const Capabilities = dynamic(() =>
  import("@/components/capabilities").then((m) => ({ default: m.Capabilities }))
)
const WhyUs = dynamic(() =>
  import("@/components/why-us").then((m) => ({ default: m.WhyUs }))
)
const ProjectsPreview = dynamic(() =>
  import("@/components/projects-preview").then((m) => ({ default: m.ProjectsPreview }))
)
